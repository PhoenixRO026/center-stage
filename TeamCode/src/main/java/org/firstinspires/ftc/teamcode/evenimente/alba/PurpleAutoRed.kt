...
//@Autonomous
class PurpleAutoRed : LinearOpMode() {
    override fun runOpMode() {
        ...
        val purplePixelPoseLeft = Pose2d(-36.5, 40.0, Math.toRadians(160.0))
        val purplePixelPoseRight = Pose2d(-30.0 - 6, 44.0, Math.toRadians(45.0))
        val purplePixelPoseMidle = Pose2d(-29.0,38.0, Math.toRadians(90.0))
