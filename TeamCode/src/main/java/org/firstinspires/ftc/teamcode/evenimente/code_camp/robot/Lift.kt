...
import org.firstinspires.ftc.teamcode.evenimente.kickoff.robot.LIFT_ID
...
class Lift(
    ...
    private val motor = hardwareMap.get(DcMotorEx::class.java, LIFT_ID)
    private val liftBottom = 0
    private val liftTop = 1600
