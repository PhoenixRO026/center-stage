...
class CRIRedMiddlePurple : MultiThreadOpMode() {
    ...
    private val midPurplePixel = Pose(-0.5.tile, -0.5.tile - 4.inch, -90.deg)
    private val leftPurplePixel = Pose(-0.5.tile + 5.inch, -1.5.tile, -90.deg)
    private val rightPurplePixel = Pose(-0.5.tile - 5.inch, -1.5.tile, 0.deg)
    ...
    override fun mainRunOpMode() {
        ...
        val actionLeft = SequentialAction(
            drive.actionBuilder(startPose)
                .strafeTo(Distance2d(-0.5.tile, -1.5.tile))
                .strafeToLinearHeading(leftPurplePixel.position, 180.deg)
        ...
        val actionMiddle = SequentialAction(
            drive.actionBuilder(startPose)
                .strafeTo(Distance2d(-0.5.tile, -1.5.tile))
                .strafeToLinearHeading(Distance2d(-0.5.tile, -1.5.tile - 5.inch), 90.deg)
                .stopAndAdd(intake.ejectPurple())
                .strafeTo(Distance2d(-0.5.tile, -1.5.tile))
                .build()
        )
        ...
        val actionRight = SequentialAction(
            drive.actionBuilder(startPose)
                .strafeTo(Distance2d(-0.5.tile, -1.5.tile))
                .strafeToLinearHeading(rightPurplePixel.position, 0.deg)
                .stopAndAdd(intake.ejectPurple())
                .strafeTo(Distance2d(-0.5.tile, -1.5.tile))
                .build()
        )
