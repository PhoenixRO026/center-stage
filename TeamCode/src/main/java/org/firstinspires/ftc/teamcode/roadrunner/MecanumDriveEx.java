...
import org.firstinspires.ftc.teamcode.robot.hardware.MotorEx;
...
public final class MecanumDriveEx {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.leftFront.getInternalMotor()));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.leftBack.getInternalMotor()));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.rightBack.getInternalMotor()));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.rightFront.getInternalMotor()));
    ...
    public MecanumDriveEx(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = MotorEx.Companion.rev12to1(hardwareMap.get(DcMotorEx.class, "leftFront"));
        leftBack = MotorEx.Companion.rev12to1(hardwareMap.get(DcMotorEx.class, "leftBack"));
        rightBack = MotorEx.Companion.rev12to1(hardwareMap.get(DcMotorEx.class, "rightBack"));
        rightFront = MotorEx.Companion.rev12to1(hardwareMap.get(DcMotorEx.class, "rightFront"));
