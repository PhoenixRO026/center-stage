...
class PurpleAutoBlue : LinearOpMode() {
    override fun runOpMode() {
        ...
        //val purplePixelPoseRight = Pose2d(-32.0, 44.0, Math.toRadians(135.0))
        val purplePixelPoseLeft = Pose2d(-32.0, 44.0, Math.toRadians(135.0))
        val purplePixelPoseRight = Pose2d(-30.0 - 6, 40.0, Math.toRadians(20.0))
        val purplePixelPoseMidle = Pose2d(-38.0,38.0, Math.toRadians(90.0))
        ...
        val robot = Robot2(hardwareMap, telemetry, Pose2d(-startPose.position.x, startPose.position.y, startPose.heading.log()), false, roadRunnerAuto = true)
        ...
        val actionLEFT = SequentialAction(
            ParallelAction(
                drive.mirrorActionBuilder(startPose)
            ...
            /*drive.mirrorActionBuilder(purplePixelPoseLeft)
        ...
        val actionRIGHT = SequentialAction(
            ...
            robot.lift.goToPos(0),
            /*drive.mirrorActionBuilder(purplePixelPoseRight)
        ...
        val actionMIDDLE = SequentialAction(
            ...
            robot.lift.goToPos(0),
            /*drive.mirrorActionBuilder(purplePixelPoseMidle)
