...
import org.firstinspires.ftc.teamcode.evenimente.kickoff.PIDFController.PIDCoefficients
...
class PIDArm : LinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        val controller = org.firstinspires.ftc.teamcode.evenimente.kickoff.PIDFController(
            coeffs,
            Consts.FD.kV,
            Consts.FD.kA,
            Consts.FD.kStatic
        ) { _, _ -> -cos(motor.currentPosition.toPosition()) * Consts.kG }
