...
@Autonomous
class RedLeftNoPark : LinearOpMode() {

    override fun runOpMode() {
        val dash = FtcDashboard.getInstance()
        telemetry = MultipleTelemetry(telemetry, dash.telemetry)
        val startPose = Pose(12.inch, 61.inch, 90.deg)
        val leftPurple = Pose(25.inch, 45.inch, 90.deg)
        val leftYellow = Pose(46.inch, 40.inch, 180.deg)
        val middlePurple = Pose(20.inch - 4.cm, 38.inch, 90.deg)
        val middleYellow = Pose(46.inch, 35.inch - 8.cm, 180.deg)
        val rightPurple = Pose(15.inch, 32.inch, 0.deg)
        val rightYellow = Pose(48.inch, 35.inch - 6.cm, 180.deg)
