...
class Drive(hardwareMap: HardwareMap) {
    ...
    fun driveFieldCentric(x: Number, y: Number, heading: Number) = drive.setDrivePowers(PoseVelocity2d(Vector2d(x.toDouble(), y.toDouble()).rotate(-robotHeading), heading.toDouble()).times(speed))
